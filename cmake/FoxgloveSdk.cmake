...
if(HAKO_PDU_FOXGLOVE_USE_SYSTEM_FOXGLOVE_SDK)
  ...
  elseif(WIN32)
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|AMD64)$")
      set(_hako_foxglove_target "x86_64-pc-windows-msvc")
      set(_hako_foxglove_sha "02b27c7ecb5a0124eebb6e925586a45487d56da708d0088dedb770007fb4a849")
    else()
      message(FATAL_ERROR "Unsupported Windows processor for Foxglove SDK: ${CMAKE_SYSTEM_PROCESSOR}. Only Windows x86_64 is currently verified.")
    endif()
  elseif(UNIX)
    ...
    message(FATAL_ERROR "Foxglove SDK archive selection is implemented for macOS, Linux, and Windows x86_64")
  endif()
...
elseif(WIN32)
  # The Rust-built Foxglove core uses NtCreateNamedPipeFile on Windows.
  # ntdll is not part of the default MSVC import-library set.
  target_link_libraries(foxglove_cpp PUBLIC ntdll)
endif()
